...
if (isset($_FILES['file']) && $_FILES['file']['error'] === UPLOAD_ERR_OK) {
    ...
    // Check if the uploaded file is an SVG image
    if ($fileType === 'image/svg+xml') {
        // Create a new Imagick object from the SVG file
        $image = new Imagick();
        $image->readImage($fileTmpName);

        // Set the image format to PNG
        $image->setImageFormat('png');

        // Output the PNG image to the browser as a download
        header('Content-Type: image/png');
        header('Content-Disposition: attachment; filename="' . basename($fileName, '.svg') . '.png"');
        echo $image;
        ...
        $error_msg = 'Only SVG files are allowed.';
    }
}
?>
<!DOCTYPE html>
...
<head>
  ...
  <meta name="description" content="Convert SVG to PNG online with <?php echo $app_name; ?> - a free and easy-to-use image converter tool. No software installation needed. Get fast and high-quality conversion. Try it now for free!">
  
  
  <title>Convert SVG to PNG Online - Free Image Converter Tool | <?php echo $app_name; ?></title>
                ...
                <form action="#" method="POST" enctype="multipart/form-data" class="mbr-form form-with-styler mx-auto">
                    ...
                    <div class="dragArea row">
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="name">
                            <input type="file" name="file" accept=".svg" placeholder="Name" data-form-field="name" class="form-control" value="" id="name-form7-5" required>
                        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-10">
                ...
                <h4 class="mbr-section-subtitle mbr-fonts-style mb-4 display-5"><div>Convert SVG to PNG Online - Free Image Converter Tool</div><div>
</div><div>
</div></h4>
                <p class="mbr-text mbr-fonts-style display-7">Convert SVG to PNG online with <?php echo $app_name; ?> - a free and easy-to-use image converter tool. No software installation needed. Get fast and high-quality conversion. Try it now for free!&nbsp;<br></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-10">
                ...
                <h4 class="mbr-section-subtitle mbr-fonts-style mb-4 display-5">Why should you convert SVG to PNG?</h4>
