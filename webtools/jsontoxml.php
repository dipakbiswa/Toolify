        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form action="#" method="POST" class="mbr-form form-with-styler mx-auto">
                    ...
                    Convert your JSON file to XML file&nbsp;⏩</p>
                    <div class="dragArea row">
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="name">
                            <textarea name="json" placeholder="Paste your JSON code here" rows="10" data-form-field="name" class="form-control" value="" id="name-form7-5" required></textarea>
                        </div>
                        
                        
                        <div class="col-auto mbr-section-btn align-center">
                            <button type="submit" name="convert" class="btn btn-secondary display-4">Convert ⬇️</button>
                        </div>
                        <br><br><br>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="name">
                            <textarea name="xml" placeholder="Resulting XML code will appear here" data-form-field="name" rows="10" class="form-control" id="name-form7-5"><?php if(isset($xml)) { echo $xml; } ?></textarea>
                        </div>
                    </div>
                </form>
